export const meta = {
  ...
  description:
    'LoseWeight.net gives general health information, not medical advice. When to talk to a clinician before starting, when to seek urgent care, and the limits of the calculators.',
};
