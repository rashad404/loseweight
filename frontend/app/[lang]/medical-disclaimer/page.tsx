...
import EnContent, { meta as enMeta } from '@/content/policies/en/medical-disclaimer';
import AzContent, { meta as azMeta } from '@/content/policies/az/medical-disclaimer';
import RuContent, { meta as ruMeta } from '@/content/policies/ru/medical-disclaimer';
...
const SLUG = 'medical-disclaimer' as const;
