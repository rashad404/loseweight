...
import EnContent, { meta as enMeta } from '@/content/policies/en/privacy';
import AzContent, { meta as azMeta } from '@/content/policies/az/privacy';
import RuContent, { meta as ruMeta } from '@/content/policies/ru/privacy';
