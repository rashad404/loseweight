...
import EnContent, { meta as enMeta } from '@/content/policies/en/terms';
import AzContent, { meta as azMeta } from '@/content/policies/az/terms';
import RuContent, { meta as ruMeta } from '@/content/policies/ru/terms';
