...
import EnContent, { meta as enMeta } from '@/content/policies/en/editorial-policy';
import AzContent, { meta as azMeta } from '@/content/policies/az/editorial-policy';
import RuContent, { meta as ruMeta } from '@/content/policies/ru/editorial-policy';
